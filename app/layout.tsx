...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: company.name,
    description: DESCRIPTION,
    images: [{ url: appUrl("/opengraph-image"), width: 1200, height: 630, alt: `${company.name} - Zimbabwe property` }],
  ...
  twitter: {
    ...
    title: company.name,
    description: DESCRIPTION,
    images: [{ url: appUrl("/opengraph-image"), alt: `${company.name} - Zimbabwe property` }],
  },
