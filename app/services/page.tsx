      ...
      <section className="relative overflow-hidden bg-black py-20 text-white sm:py-28 lg:py-32">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-4 lg:grid-cols-[1.15fr_0.85fr] lg:items-end lg:px-8">
          <div>
            ...
            <p className="mt-7 max-w-xl text-base leading-7 text-white sm:text-lg">Specialists in residential developments, supported by property sales, marketing, advisory, and developer partnerships.</p>
          </div>
          <div className="border-l border-white/15 pl-6 lg:mb-2 lg:pl-8">
            ...
            <p className="mt-3 text-sm leading-6 text-white">Professional service and transparent information for buyers, investors, sellers, and development partners.</p>
